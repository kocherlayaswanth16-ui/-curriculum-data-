...
function DashboardLayout({ children, role }) {
  ...
  const menuItems = {
    student: [
      ...
      { id: 'skills', name: '📈 Skills', path: '/dashboard/student?tab=career', icon: '📊' },
      { id: 'academics', name: '📚 Curriculum', path: '/dashboard/student?tab=academics', icon: '📝' },
      { id: 'sports', name: '🏅 Sports', path: '/dashboard/student?tab=activities', icon: '⚽' },
      { id: 'cultural', name: '🎭 Cultural', path: '/dashboard/student?tab=activities', icon: '🎨' },
      { id: 'jobs', name: '💼 Job Portal', path: '/jobs', icon: '🚀' },
      { id: 'market', name: '🌍 Market Intel', path: '/market-intelligence', icon: '💡' },
      { id: 'mentors', name: '🤝 Mentors', path: '/mentor-connect', icon: '🧠' },
      { id: 'leaderboard', name: '🏆 Leaderboard', path: '/leaderboard', icon: '🎖️' },
      { id: 'prediction', name: '🔮 Career Path', path: '/career-prediction', icon: '✨' },
      { id: 'resume', name: '📝 Resume AI', path: '/resume-optimizer', icon: '📄' },
    ],
    faculty: [
      { id: 'overview', name: '🏠 Dashboard', path: '/dashboard/faculty', icon: '📊' },
      ...
      { id: 'students', name: '👥 Student Lookup', path: '/student-lookup', icon: '🔍' },
    ],
    hod: [
      { id: 'overview', name: '🏠 Dashboard', path: '/dashboard/hod', icon: '🏛️' },
      { id: 'curriculum_planning', name: '🎓 Curriculum Planner', path: '/curriculum-planner', icon: '🛠️' },
      { id: 'curriculum', name: '🛠️ Curriculum Planning', path: '/dashboard/hod?tab=curriculum', icon: '📋' },
      { id: 'analysis', name: '📊 Dept Analysis', path: '/dashboard/hod?tab=analysis', icon: '📉' },
      { id: 'syllabus', name: '📂 Syllabus Analysis', path: '/upload-syllabus', icon: '⚙️' },
    ],
    admin: [
      { id: 'overview', name: '🏠 Dashboard', path: '/dashboard/admin', icon: '👑' },
      { id: 'users', name: '👥 User Management', icon: '⚙️', path: '/dashboard/admin?tab=users' },
      { id: 'events', name: '📅 Events & Alerts', icon: '🔔', path: '/dashboard/admin?tab=events' },
      { id: 'settings', name: '🛠️ System Settings', icon: '⚙️', path: '/dashboard/admin?tab=settings' },
